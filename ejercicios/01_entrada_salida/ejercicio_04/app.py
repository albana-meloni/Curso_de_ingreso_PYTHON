...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        nombre_guardado = prompt(title="nombre :o", prompt="¿cuál es tu nombre?")
        caja_de_texto = self.txt_nombre.get()
        longitud_texto = len(caja_de_texto)
        self.txt_nombre.delete(0, longitud_texto)
        self.txt_nombre.insert(0, nombre_guardado)
